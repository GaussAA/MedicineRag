...
class QueryExpander:
    ...
    SYNONYMS = {
        # 心血管系统
        "高血压": ["高血压", "高血压病", "血压高", "血压升高", "血压异常", "血压增高"],
        "低血压": ["低血压", "血压低", "血压降低", "血压下降"],
        "冠心病": ["冠心病", "冠状动脉粥样硬化性心脏病", "冠状动脉心脏病"],
        "心绞痛": ["心绞痛", "胸痛", "心前区疼痛", "胸闷"],
        "心肌梗死": ["心肌梗死", "心梗", "心肌梗塞", "冠状动脉栓塞"],
        "心律失常": ["心律失常", "心律不齐", "心率失常", "心跳异常"],
        "心力衰竭": ["心力衰竭", "心衰", "心脏衰竭", "心功能不全"],
        "脑卒中": ["脑卒中", "中风", "脑血管意外", "脑溢血", "脑梗死"],
        
        # 呼吸系统
        "感冒": ["感冒", "上呼吸道感染", "流感", "发热", "伤风"],
        "肺炎": ["肺炎", "肺部感染", "肺炎症", "支气管肺炎"],
        "支气管炎": ["支气管炎", "支气管炎症", "气管炎"],
        "哮喘": ["哮喘", "支气管哮喘", "气喘", "喘息"],
        "肺结核": ["肺结核", "结核病", "肺痨", "结核"],
        "咳嗽": ["咳嗽", "咳痰", "干咳", "咳嗽不止"],
        "发烧": ["发烧", "发热", "体温升高", "高烧", "体温异常"],
        
        # 消化系统
        "胃炎": ["胃炎", "胃部炎症", "胃黏膜炎症", "胃病"],
        "胃溃疡": ["胃溃疡", "胃部溃疡", "胃黏膜溃疡"],
        "肝炎": ["肝炎", "肝脏炎症", "肝炎症", "病毒性肝炎"],
        "肝硬化": ["肝硬化", "肝脏硬化", "肝纤维化"],
        "胆囊炎": ["胆囊炎", "胆囊炎症", "胆囊疾病"],
        "胰腺炎": ["胰腺炎", "胰脏炎症", "胰腺炎症"],
        "胃痛": ["胃痛", "胃部不适", "腹痛", "肚子疼", "腹部疼痛"],
        "腹泻": ["腹泻", "拉肚子", "大便稀薄", "水样便"],
        "便秘": ["便秘", "大便干燥", "排便困难", "排便不畅"],
        
        # 泌尿系统
        "肾炎": ["肾炎", "肾脏炎症", "肾炎症", "肾小球肾炎"],
        "尿路感染": ["尿路感染", "泌尿道感染", "尿道炎", "膀胱炎"],
        "前列腺炎": ["前列腺炎", "前列腺炎症", "前列腺疾病"],
        
        # 内分泌系统
        "糖尿病": ["糖尿病", "高血糖", "血糖高", "血糖异常", "血糖升高"],
        "甲状腺功能亢进": ["甲亢", "甲状腺功能亢进", "甲状腺亢进"],
        "甲状腺功能减退": ["甲减", "甲状腺功能减退", "甲状腺低下"],
        
        # 神经系统
        "头痛": ["头痛", "头疼", "头晕", "眩晕", "头昏"],
        "失眠": ["失眠", "睡眠障碍", "难以入睡", "睡眠困难"],
        "抑郁症": ["抑郁症", "抑郁", "情绪低落", "忧郁"],
        "焦虑症": ["焦虑症", "焦虑", "焦虑障碍", "紧张"],
        
        # 骨科
        "关节炎": ["关节炎", "关节炎症", "关节疼痛", "关节不适"],
        "骨质疏松": ["骨质疏松", "骨密度降低", "骨质减少"],
        "腰椎间盘突出": ["腰椎间盘突出", "腰突", "腰椎间盘脱出", "腰间盘突出"],
        
        # 皮肤科
        "湿疹": ["湿疹", "皮肤炎", "过敏性皮炎", "皮肤瘙痒"],
        "荨麻疹": ["荨麻疹", "风疹", "皮肤过敏", "风团"],
        "银屑病": ["银屑病", "牛皮癣", "银斑"],
        ...
        # 常见症状
        "胸闷": ["胸闷", "胸憋", "胸部不适", "气短"],
        "呼吸困难": ["呼吸困难", "气促", "呼吸不畅", "喘不上气"],
        "恶心": ["恶心", "想吐", "反胃", "呕吐感"],
        "呕吐": ["呕吐", "吐", "恶心呕吐", "喷射性呕吐"],
        "乏力": ["乏力", "疲倦", "疲劳", "没力气", "全身无力"],
        "体重下降": ["体重下降", "消瘦", "体重减轻", "变瘦"],
        "水肿": ["水肿", "浮肿", "身体肿胀", "下肢浮肿"],
    }
...
class HybridRetriever:
    ...
    def _post_process(
        ...
        if similarity_threshold > 0:
            ...
            if filtered_count > 0:
                logger.info(f"相似度阈值过滤：移除 {filtered_count} 个低相关性文档 (阈值={similarity_threshold})")
